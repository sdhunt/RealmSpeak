...
/**
 * A text field that can make suggestions to the user.
 */
public class SuggestionTextField extends JTextField {
    ...
    /**
     * Creates an empty suggestion text field.
     */
    ...
    /**
     * Creates a suggestion text field initialized with the given text.
     *
    ...
    /**
     * Inserts the given string at the specified position (insertion index)
     * of this text field.
     *
