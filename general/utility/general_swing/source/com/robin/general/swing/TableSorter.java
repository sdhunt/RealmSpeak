...
public class TableSorter extends TableMap {
    ...
    public int compareDateAndStringObjects(Object o1, Object o2) {
        if (o1.getClass() == java.util.Date.class) {
            return 1;
    ...
    private void markColumn(ColumnSort cs) {
        if (theTable != null && cs.getColumn() < getColumnCount()) {
            TableColumn tc = theTable.getTableHeader().getColumnModel()
                    .getColumn(theTable.convertColumnIndexToView(cs.getColumn()));
    ...
    private class ArrowGraphic extends ImageIcon {
        ...
        public void init() {
            ...
            foreground = convertColor(selBg, Color.black, 20);
        }
    ...
    private class HeaderMark extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table,
            ...
            setBorder(new BevelBorder(BevelBorder.RAISED,
                                      convertColor(cellBorderColor, Color.white, 50),
                                      convertColor(cellBorderColor, Color.black, 50)));
            setOpaque(true);
    ...
    public static TableModel getBaseModel(JTable table) {
        ...
        while (model instanceof TableSorter) {
